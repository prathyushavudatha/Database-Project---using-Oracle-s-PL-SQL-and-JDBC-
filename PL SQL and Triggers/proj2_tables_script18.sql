...
insert into logs values (1, 'Aly', '16-NOV-18', 'students', 'insert', 'B006');
insert into logs values (2, 'Prats', '26-OCT-18', 'enrollments', 'delete', 'B005');
insert into logs values (3, 'Babu', '05-NOV-18', 'courses', 'insert', '432');
insert into logs values (4, 'Preetham', '23-OCT-18', 'classes', 'update', 'C0004');
